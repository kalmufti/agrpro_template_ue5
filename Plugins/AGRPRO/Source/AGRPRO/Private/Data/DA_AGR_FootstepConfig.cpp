...
void UDA_AGR_FootstepConfig::GetVelocityRange(float& MinRange, float& MaxRange)
{
	MinRange = MinVelocity;
	MaxRange = MaxVelocity;
}

void UDA_AGR_FootstepConfig::GetFoostepSettings(USoundAttenuation*& AttenuationRef, USoundConcurrency*& ConcurrencyRef)
{
