...
public:
	// Get sound cues realtive to the physical surfaces called
	...
	UFUNCTION(BlueprintCallable, Category = "AGR Footsteps")
	void GetVelocityRange(float& MinRange , float& MaxRange);

	UFUNCTION(BlueprintCallable, Category = "AGR Footsteps")
	void GetFoostepSettings(USoundAttenuation*& AttenuationRef, USoundConcurrency*& ConcurrencyRef);
